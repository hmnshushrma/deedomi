    ...
    <section className="operations" id="fonctionnement">
      <div className="operations__container">
        <div className="operations__heading">
          ...
          <h3 className="operations__heading--subtitle">
            Comment utiliser notre{' '}
            <span className="operations__heading--subtitle--highlight">
              application mobile ?
            </span>
          </h3>
          <p className="operations__heading--subtext">
            Découvrez en quelques étapes simples comment publier, gérer et
            donner vos vêtements grâce à l'application DEEDOMI. De la création
            de votre don jusqu'à l'accord de récupération, l'application vous
        ...
        <div className="operations__stages">
          {stageDefinitions.map((stage) => (
            <div
              className="operations__stage"
              key={stage.id}
              style={{
                flexDirection: stage.id % 2 === 0 ? 'row-reverse' : 'row',
              }}
            >
              ...
              <div className="operations__stage--img">
                <img src={stage.image} alt="stage1" width="100%" />
              </div>
            </div>
          ))}
        </div>
